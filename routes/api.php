...
Route::prefix('v1')->namespace('Api')->group(function () {
	...
	//JAS-profile
	Route::post('/ghg/upsertProfile/{id?}', 'JasController@upsert');
	Route::get('/ghg/getProfiles/{id?}', 'JasController@get');
	Route::post('/ghg/delete/{id}', 'JasController@delete');
	Route::get('/ghg/getProfileByTps/{id?}', 'JasController@getByTps');
	Route::get('/ghg/getJasProfileData/{id}', 'JasController@getJasProfileData');

	//jas-activities
	Route::get('/ghg/getActivities', 'JasController@getActivities');

	//jas-monitoring
	Route::post('/ghg/upsertMonitoring/{id?}', 'JasController@upsertMonitoring');
	Route::get('/ghg/getMonitoring/{id?}', 'JasController@getMonitoring');
	Route::get('/ghg/getMonitoringByProfile/{id}', 'JasController@getMonitoringByProfile');
	Route::post('/ghg/deleteMonitoring/{id}', 'JasController@deleteMonitoring');


	//jas summaries
	Route::get('/ghg/getSummaries/{level?}', 'JasController@getSummaries');
	Route::get('/ghg/getSummaryReportPDF','JasController@getJasSummaryReportPDF');

	//jas-monitoring data
	Route::post('/ghg/upsertMonitoringData/{id?}', 'JasController@upsertMonitoringData');
	Route::get('/ghg/getMonitoringData/{id?}', 'JasController@getMonitoringData');
	Route::get('/ghg/getMonitoringDataByProfile/{id}', 'JasController@getMonitoringDataByProfile');
	Route::post('/ghg/deleteMonitoringData/{id}', 'JasController@deleteMonitoringData');
